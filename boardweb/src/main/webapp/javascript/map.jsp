...
<body>
	...
	<script>
		...
		var iwContent = '<div style="padding:5px; margin:5px;">${param.name} <br><a href="https://map.kakao.com/link/map/${param.name},${param.lat},${param.lng}" style="color:blue" target="_blank">큰지도보기</a> <a href="https://map.kakao.com/link/to/${param.name},${param.lat},${param.lng}" style="color:blue" target="_blank">길찾기</a></div>';
